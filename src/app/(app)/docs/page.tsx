    ...
    <div className="space-y-4">
      ...
      <Card className="border-amber-200 bg-amber-50">
        ...
        <p className="text-sm text-amber-900">
          ИИ-юрист формирует краткую оценку рисков и не заменяет профессиональную юридическую экспертизу. Проверка персональных данных возможна только при наличии согласия.
        </p>
      </Card>
