...
const steps = [
  {
    ...
    description: "Добавьте Google Sheets, CSV/Excel или CRM webhook, чтобы система увидела фактические цифры бизнеса.",
  ...
  {
    title: "3. Задайте вопрос AI-советнику",
    ...
    action: { href: "/advisor", label: "Открыть AI-советник" }
  },
  {
    title: "4. Сохраните полезный виджет",
    description: "Сохраните результат AI-анализа в дашборд, чтобы ключевые метрики были перед глазами каждый день.",
