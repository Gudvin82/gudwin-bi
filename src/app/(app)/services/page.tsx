...
const links = [
  ...
  { href: "/connect", title: "Интеграции", note: "Связи с внешними сервисами и правила IF/THEN" },
  ...
  { href: "/desktop-agent", title: "Desktop AI агент (v2+)", note: "Архитектура и дорожная карта локального агента" },
