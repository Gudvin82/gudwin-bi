...
export async function GET() {
  ...
  return NextResponse.json({ events, _meta: { mode: "prod", generatedAt: new Date().toISOString() } });
}
...
export async function POST(request: Request) {
  ...
  return NextResponse.json({ event, _meta: { mode: "prod", generatedAt: new Date().toISOString() } });
}
...
export async function PATCH(request: Request) {
  ...
  return NextResponse.json({ event: item, _meta: { mode: "prod", generatedAt: new Date().toISOString() } });
}
