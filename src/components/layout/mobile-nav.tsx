...
import { BarChart3, Bell, Brain, Home, Wallet } from "lucide-react";
...
export function MobileNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200 bg-white/95 px-2 pb-2 pt-2 backdrop-blur-xl md:hidden">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? "bg-cyan-50 text-cyan-700" : "text-slate-600"
              )}
            >
              <Icon size={16} />
